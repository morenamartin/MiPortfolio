...
const Contacto = ({ id }: { id: string }) => {
    return (
        <div id={id} className="px-40 pb-20 mt-36">
            ...
            <h2 className="px-40 mt-8 text-xl text-center text-gray-600">¿Tienes un proyecto en mente? Me encantaría conocer más sobre tu idea y cómo puedo ayudarte a hacerla realidad.</h2>

            <div className="grid grid-cols-2 gap-20 mt-12">
                <div>
                    <h5 className="mb-4 text-2xl font-bold">Hablemos</h5>
                    <span className="font-medium text-gray-500">Estoy disponible para proyectos freelance y oportunidades laborales. No dudes en contactarme.</span>
                    ...
                    <div className="grid grid-rows-3 gap-8 mt-12">
                        ...
                        <div className="flex flex-row gap-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                className="w-[450px] text-gray-700 hover:text-[#9333ea]">
                        ...
                        <div className="flex flex-row gap-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                className="w-[450px] text-gray-700 hover:text-[#8b5cf6]">
                                    11 4086-4329
                                </a>
                            </div>
                        </div>
                        <div className="flex flex-row gap-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="w-[450px] text-gray-700 ">
                ...
                <div>
                    <h5 className="mb-4 text-2xl font-bold">Seguime</h5>
                    <span className="font-medium text-gray-500">Encuéntrame en LinkedIn para networking profesional y en GitHub para ver mis trabajos y repositorios.</span>
